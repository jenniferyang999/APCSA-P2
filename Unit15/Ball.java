	   ...
	   //add the get methods
		  public int getXSpeed() 
		   ...
		   public boolean didCollideRight(Object obj){
				Block test = (Block)obj;
				if (getX() < test.getX() && getX() + getWidth() >= test.getX() && (getY() >= test.getY() && getY() + getHeight() <= test.getY()+test.getHeight())){
					return true;
				}
				return false;
			}
